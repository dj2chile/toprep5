                        ...
                        <div>
                                    ...
                                    <div id="device-model-edit-form" class="mt-2 hidden">
                                        <form onsubmit="return updateDeviceModel(event)">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <button type="button" onclick="toggleDeviceModelEdit()" class="ml-1 inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-gray-50 hover:bg-gray-100">
                                                    Anuluj
                                                </button>
                                            </div>
                                        </form>
                                    ...
                                    <div id="serial-edit-form" class="mt-2 hidden">
                                        <form onsubmit="return updateSerial(event)">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <button type="button" onclick="toggleSerialEdit()" class="ml-1 inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-gray-50 hover:bg-gray-100">
                                                    Anuluj
                                                </button>
                                            </div>
                                        </form>
                                    ...
                                    <div id="phone-edit-form" class="mt-2 hidden">
                                        <form onsubmit="return updatePhoneNumber(event)">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <button type="button" onclick="togglePhoneEdit()" class="ml-1 inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-gray-50 hover:bg-gray-100">
                                                    Anuluj
                                                </button>
                                            </div>
                                        </form>
                            ...
                            <div class="mt-8">
                                ...
                                <div class="mt-2 grid grid-cols-3 gap-2">
                                    <button type="button" 
                                            class="option-button <?= $initial_options['option_expertise'] ? 'option-selected' : '' ?> <?= $repair['option_expertise'] ? 'option-active' : '' ?> inline-flex items-center justify-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50" 
                                            data-type="repair" data-name="option_expertise" data-value="<?= $repair['option_expertise'] ? 'true' : 'false' ?>">
                                        Ekspertyza
                                    </button>
                                    <button type="button" 
                                            class="option-button <?= $initial_options['option_repair'] ? 'option-selected' : '' ?> <?= $repair['option_repair'] ? 'option-active' : '' ?> inline-flex items-center justify-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50" 
                                            data-type="repair" data-name="option_repair" data-value="<?= $repair['option_repair'] ? 'true' : 'false' ?>">
                                        Naprawa
                                    </button>
                                    <button type="button" 
                                            class="option-button <?= $initial_options['option_supplies'] ? 'option-selected' : '' ?> <?= $repair['option_supplies'] ? 'option-active' : '' ?> inline-flex items-center justify-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50" 
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-2 grid grid-cols-2 gap-2">
                                    <button type="button" 
                                            class="cable-button <?= $initial_options['usb_cable'] ? 'option-selected' : '' ?> <?= $repair['usb_cable'] ? 'option-active' : '' ?> inline-flex items-center justify-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50" 
                                            data-type="cable" data-name="usb_cable" data-value="<?= $repair['usb_cable'] ? 'true' : 'false' ?>">
                                        USB
                                    </button>
                                    <button type="button" 
                                            class="cable-button <?= $initial_options['power_cable'] ? 'option-selected' : '' ?> <?= $repair['power_cable'] ? 'option-active' : '' ?> inline-flex items-center justify-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50" 
